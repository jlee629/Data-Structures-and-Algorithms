...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    public static void main(String[] args) {
        ...
        Position<String> p1 = list.addLast("A"); // 2
        Position<String> p2 = list.addFirst("B"); // 1
        Position<String> p3 = new LinkedPositionalList.Node<>("C", null, null); // -1
        Position<String> p4 = list.addBefore(p2,"D"); // 0
        Position<String> p5 = list.addAfter(p1, "E"); // 3

        System.out.println("Index of p1: " + list.indexOfPosition(p1));
        System.out.println("Index of p2: " + list.indexOfPosition(p2));
        System.out.println("Index of p3: " + list.indexOfPosition(p3));
        System.out.println("Index of p4: " + list.indexOfPosition(p4));
        System.out.println("Index of p5: " + list.indexOfPosition(p5));
    }
