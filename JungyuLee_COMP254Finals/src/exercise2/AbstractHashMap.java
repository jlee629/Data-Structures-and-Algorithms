...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
    ...
    private double maxLoadFactor;        // the maximum load factor
    ...
    /** Creates a hash table with given capacity, prime factor 109345121 and maximum load factor. */
    public AbstractHashMap(int cap, double maxLoadFactor) { this(cap, 109345121, maxLoadFactor); }  // default prime

    /** Creates a hash table with capacity 17, prime factor 109345121 and maximum load factor 0.5. */
    public AbstractHashMap() { this(17, 0.5); } // default capacity and load factor
    ...
    public V put(K key, V value) {
        ...
        if (n > capacity * maxLoadFactor)              // check against maxLoadFactor
