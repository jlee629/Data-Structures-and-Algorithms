...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public static void main(String[] args) {
        ...
        Position<Integer> left = lbt.addLeft(root, 2);
        Position<Integer> right = lbt.addRight(root, 3);

        Position<Integer> leftLeft = lbt.addLeft(left, 4);
        Position<Integer> leftRight = lbt.addRight(left, 5);

        Position<Integer> rightLeft = lbt.addLeft(right, 6);
        Position<Integer> rightRight = lbt.addRight(right, 7);

        Position<Integer> leftLeftLeft = lbt.addLeft(leftLeft, 8);
        Position<Integer> rightLeftRight = lbt.addRight(rightLeft,9);

        System.out.println("sum of leaves = " + lbt.sumOfLeaves());
    }
