...
public class UnsortedTableMap<K,V> extends AbstractMap<K,V> {
    ...
    public static void main(String[] args) {
        UnsortedTableMap<String, Integer> unsortedTableMap = new UnsortedTableMap<>();

        unsortedTableMap.put("A", null);

        // get Test
        System.out.println("-----get Test-----");
        System.out.println("key O value null =\t" + unsortedTableMap.get("A"));
        System.out.println("key X value X =\t" + unsortedTableMap.get("E"));

        System.out.println();
        // containsKey Test
        System.out.println("-----containsKey Test-----");
        System.out.println("key O value null =\t" + unsortedTableMap.containsKey("A"));
        System.out.println("key X value X =\t" + unsortedTableMap.containsKey("E"));
    }
